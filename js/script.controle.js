...
{	
	...
	sobreGeral.innerHTML = "A filosofia deste jogo está dividida em duas partes:<br><br>• Aprender conceitos básicos da programação: Lógica matemática e estruturas condicionais e de repetição; <br>• Testar sua memória associando, por meio de seus conhecimentos, duas cartas que se complementam, sendo possivel aprender os conceitos utilizados neste jogo acessando algumas cartas no botão com um ponto de interrogação (?).<br><br>Aprenda mais sobre a programação neste desafio de memória!";
...
function buildCreditos()
{
	...
	para.innerHTML = "Equipe da versão original (Quimemória):";
	el.appendChild(para);	
	...
	var para = document.createElement("p");
	para.innerHTML = "Promemória criado por: Douglas";
	el.appendChild(para);	
	...
	/*var colLeft2 = document.createElement("div");
	colLeft2.setAttribute("style", "width: 250px; float: left;  text-align: center;");
	el.appendChild(colLeft2);
	
	var para = document.createElement("p");
	para.innerHTML = "Marilde";
	colLeft2.appendChild(para);

	var colCenter2 = document.createElement("div");
	colCenter2.setAttribute("style", "width: 250px; float: center;  text-align: center;");
	el.appendChild(colCenter2);
	
	var para = document.createElement("p");
	para.innerHTML = "Joice";
	colCenter2.appendChild(para);

	var colRight2 = document.createElement("div");
	colRight2.setAttribute("style", "width: 250px; float: right;  text-align: center;");
	el.appendChild(colRight2);
	
	var para = document.createElement("p");
	para.innerHTML = "Delano";
	colRight2.appendChild(para);*/
